...
/* 
  This is a java file that contain User-Agent element.
  How it works:https://zhuanlan.zhihu.com/p/35625779
  The element list:https://github.com/mkstayalive/random-user-agent-java/tree/master
*/
...
public class UserAgentData {
  ...
  public static Map<String, Object> getAllData() {
    ...
    allData.put("uaMap", uaMap);
    allData.put("freqMap", freqMap);

    return allData;
  }

  public String getRandomUserAgent() {
    Map<String, Object> allData = UserAgentData.getAllData();

    Map<String, String[]> uaMap = (Map<String, String[]>) allData.get("uaMap");
    Map<String, Double> freqMap = (Map<String, Double>) allData.get("freqMap");

    Random random = new Random();
    String[] allUserAgents = uaMap.values().stream().flatMap(Arrays::stream).toArray(String[]::new);
    return allUserAgents[random.nextInt(allUserAgents.length)];
 ...
 * 
 * Random random = new Random();
 * String[] allUserAgents =
 * uaMap.values().stream().flatMap(Arrays::stream).toArray(String[]::new);
 * return allUserAgents[random.nextInt(allUserAgents.length)];
 * }
 * //For hiding the headless chrome
 * 
